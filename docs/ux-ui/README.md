...
- 현재 UI는 기능 흐름은 갖춰졌지만, 레이아웃 규칙과 상태 피드백 규칙이 문서화되어 있지 않다.
...
1. `00-project-overview.md`를 읽고 실행 방법, 구조, 기술 스택 파악
2. `02-design-system.md` 기준으로 토큰과 레이아웃 규칙부터 통일
3. `04-priority-backlog.md`의 P0 항목 처리
4. `03-page-improvements.md` 기준으로 주요 사용자 흐름 화면 순차 개선
5. `05-ai-collaboration-guide.md`의 검증 규칙에 따라 AI 출력물 점검
6. 마지막에 접근성 점검과 모바일 실기기 확인
